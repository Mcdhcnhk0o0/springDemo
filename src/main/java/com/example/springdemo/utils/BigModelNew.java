...
public class BigModelNew extends WebSocketListener {
    ...
    // 主函数
    public WebSocket start(String message) throws Exception {
    ...
    public void onMessage(WebSocket webSocket, String text) {
        ...
        System.out.println();
        System.out.println("===================================");
        System.out.println("total: " + totalAnswer);
        if (myJsonParse.header.status == 2) {
            ...
            LLMResponse.RoleContent content = new LLMResponse.RoleContent();
            content.setContent("assistant");
            content.setContent(totalAnswer);
            LLMChatRecorder.getInstance().record(0L, content);
            wsCloseFlag = true;
            totalFlag=true;
        }
    }
